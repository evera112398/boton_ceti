...
class SendSMSCode extends StatefulWidget {
  final String celular;
  const SendSMSCode({super.key, required this.celular});

  @override
  State<SendSMSCode> createState() => _SendSMSCodeState();
}

class _SendSMSCodeState extends State<SendSMSCode> {
                ...
                child: FutureBuilder(
                  future: Future.delayed(
                    ...
                    (value) => singletonProvider.usuariosController
                        .sendCodigoValidacionCelular(widget.celular),
                  ),
